 ...
 * @usage
 * ```js
 * var ionicProject = angular.module('reallyCoolApp', ['ionic']);
 *
 * ionicProject.config(function($ionicConfigProvider) {
 ...
 * @usage
 * ```js
 * var app = angular.module('ionicProject', ['ionic'])
 ...
 *
 * ```js
 *   angular.module('ionicProject', ['ionic'])
